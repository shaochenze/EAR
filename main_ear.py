...
from models import ear
from engine_ear import train_one_epoch, evaluate
import copy


def get_args_parser():
    parser = argparse.ArgumentParser('EAR training with Energy Loss', add_help=False)
    parser.add_argument('--score_lrscale', default=0.25, type=float,
                        help="lr scale for MLP generator")
    parser.add_argument('--accumulation_steps', default=1, type=int,
                        help="graident accumulation steps")
    parser.add_argument('--alpha', default=1.0, type=float,
                        help="hyperparameter for energy score, 0 < alpha < 2")
    parser.add_argument('--noise_channels', default=64, type=int,
    ...
    # Model parameters
    parser.add_argument('--model', default='ear_base', type=str, metavar='MODEL',
    ...
    # Score Loss params
    parser.add_argument('--scoreloss_d', type=int, default=6)
    parser.add_argument('--scoreloss_w', type=int, default=1024)
    parser.add_argument('--score_batch_mul', type=int, default=1)
    parser.add_argument('--train_temperature', default=1.0, type=float,
                        help='training time temperature')
    parser.add_argument('--infer_temperature', default=1.0, type=float,
                        help='inference time temperature')
...
def main(args):
    ...
    model = ear.__dict__[args.model](
        ...
        scoreloss_d=args.scoreloss_d,
        scoreloss_w=args.scoreloss_w,
        score_batch_mul=args.score_batch_mul,
    ...
    eff_batch_size = args.batch_size * misc.get_world_size() * args.accumulation_steps
    ...
    param_groups = misc.add_weight_decay_scorelr(model_without_ddp, args.weight_decay, args.score_lrscale)
