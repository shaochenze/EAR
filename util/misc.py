...
def add_weight_decay_scorelr(model, weight_decay=1e-5, score_lrscale=1, skip_list=()):
    decay = []
    no_decay = []
    score_param = []
    for name, param in model.named_parameters():
        ...
        elif 'scoreloss' in name:
            score_param.append(param)
        else:
            decay.append(param)
    return [
        {'params': no_decay, 'weight_decay': 0.},
        {'params': decay, 'weight_decay': weight_decay},
        {'params': score_param, 'weight_decay': 0., 'lr_scale': score_lrscale}]
